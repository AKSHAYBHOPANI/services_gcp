...
export async function POST(req, res) {
  ...
  const { name, email, message, cred, when, mobile, service } = body
  ...
  if (cred === process.env.NEXT_PUBLIC_CRED) {
    ...
    let info = await transporter.sendMail({
      ...
      subject: `Contact Request || ${name} || The Tech Show Media`, // Subject line
      text: "Thank you for Submitting Contact Form on The Tech Show.", // plain text body
      html: `<!DOCTYPE html>
                                              ...
                                              <table border="0" cellpadding="0" cellspacing="0" width="100%" role="presentation">
                                                <tbody>
                                                  <tr>
                                                    <td style="padding-right: 24px; padding-left: 24px" class="mceBlockContainer" valign="top">
                                                      <div data-block-id="3" class="mceText" id="dataBlockId-3" style="width: 100%">
                                                        <h1>Thank you for Submitting Contact Form on The Tech Show.</h1>
                                                        <p class="last-child">${message}<br /><br />Service Type: ${service}<br />Contact No: ${mobile}<br /></p>
                                                      </div>
                                                    </td>
                                                  </tr>
                                                  <!-- <tr>
                                                  ...
                                                  <tr>
                                                    <td style="padding-right: 24px; padding-left: 24px" class="mceBlockContainer" valign="top">
                                                      <div data-block-id="3" class="mceText" id="dataBlockId-3" style="width: 100%">
                                                        <p class="last-child">*Automated Mailing System for Contact Form Submitted on The Tech Show at ${when} by ${email}. Our Team will reply on this Mail shortly.</p>
                                                      </div>
                                                    </td>
                                                  </tr>
                                                  <tr>
