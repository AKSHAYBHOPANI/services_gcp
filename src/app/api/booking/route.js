...
export async function POST(req, res) {
  ...
  const { name, email, message, cred, when, mobile, cart, qty, price } = body
  // let testAccount = await nodemailer.createTestAccount()
  let cartList = await JSON.parse(cart)
  cartList = cartList.map((prod) => prod.name)
  ...
  let transporter = nodemailer.createTransport({
    ...
    auth: {
      user: process.env.MAILIDSUPPORT, // generated ethereal user
      pass: process.env.MAILPASSSUPPORT, // generated ethereal password
    },
    tls: {
      rejectUnauthorized: false,
    },
  })
  console.log(process.env.NEXT_PUBLIC_CRED, cred)
  if (cred === process.env.NEXT_PUBLIC_CRED) {
    // Update Firebase DB
    const BookingCheckout = db.collection("users").doc(email)
    const data = await BookingCheckout.set(
      {
        cart: cartList,
        price: price,
        when: when,
    ...
    let info = await transporter.sendMail({
      from: process.env.MAILIDSUPPORT, // sender address
      to: `${email}, ${process.env.MAILIDSUPPORT}`, // list of receivers
      subject: `Booking || ${name} || The Tech Show Media`, // Subject line
      text: "Thank you for Booking Service on The Tech Show.", // plain text body
      html: `<!DOCTYPE html>
<html xmlns="http://www.w3.org/1999/xhtml" xmlns:v="urn:schemas-microsoft-com:vml" xmlns:o="urn:schemas-microsoft-com:office:office">
  ...
  <body>
    <!---->
    <!--[if !gte mso 9]><!----><span class="mcnPreviewText" style="display: none; font-size: 0px; line-height: 0px; max-height: 0px; max-width: 0px; opacity: 0; overflow: hidden; visibility: hidden; mso-hide: all">Download For Free</span><!--<![endif]-->
    <!---->
    <center>
                                          ...
                                          <tr>
                                            <td style="padding-top: 0; padding-bottom: 0" class="mceColumn" data-block-id="-10" valign="top" colspan="12" width="100%">
                                              <table border="0" cellpadding="0" cellspacing="0" width="100%" role="presentation">
                                                <tbody>
                                                  <tr>
                                                    <td style="padding-right: 24px; padding-left: 24px" class="mceBlockContainer" valign="top">
                                                      <div data-block-id="3" class="mceText" id="dataBlockId-3" style="width: 100%">
                                                        <h1>Thank you, ${name} for Booking Service on The Tech Show.</h1>
                                                        <p class="last-child">${message}<br /><br />Contact No: ${mobile}<br />Products:${cartList}<br />Qty:${qty}<br />Price:${price}<br /><br /></p>
                                                      </div>
                                                    </td>
                                                  </tr>
                                                      ...
                                                      <table align="center" border="0" cellpadding="0" cellspacing="0" role="presentation" data-block-id="5">
                                                        <tbody>
                                                          <tr class="mceStandardButton">
                                                            <td style="background-color: #000000; border-radius: 0; text-align: center" class="mceButton" valign="top">
                                                              <a
                                                                href="https://calendly.com/akshaybhopani/30min"
                                                                target="_blank"
                                                                style="
                                                            ...
                                                            <!--[if mso]>
                                                              <td align="center">
                                                                <v:roundrect
                                                                  ...
                                                                  href="https://downloads.yourtechshow.com/2019/09/top-ganpati-bappa-hd-wallpapers-ganesh.html?m=1"
                                                                  style="v-text-anchor: middle; width: 169.61px; height: 57px"
                                                                  arcsize="0%"
                                                                  strokecolor="#000000"
                                                                  strokeweight="2px"
                                                                  fillcolor="#000000"
                                                                          ...
                                                                          <tr>
                                                                            <td align="center" valign="top">
                                                                              <table border="0" cellpadding="0" cellspacing="0" width="" role="presentation" class="mceClusterLayout" data-block-id="-8">
                                                                                <tbody>
                                                                                  <tr>
                                                                                    <td style="padding-left: 24px; padding-top: 0; padding-right: 24px" data-breakpoint="4" valign="top" class="mobileClass-4">
                                                                                      <a href="https://www.facebook.com/thetechshowmedia"
                                                                                        ><img
                                                                                          data-block-id="-5"
                                                                                          width="40"
                                                                                          height="auto"
                                                                                          style="width: 40px; height: auto; max-width: 100%; display: block"
                                                                                          alt="Facebook icon"
                                                                                    ...
                                                                                    <td style="padding-left: 24px; padding-top: 0; padding-right: 24px" data-breakpoint="4" valign="top" class="mobileClass-4">
                                                                                      <a href="https://twitter.com/ttsmgofficial">
                                                                                        <img
                                                                                          data-block-id="-6"
                                                                                          width="40"
                                                                                          height="auto"
                                                                                    ...
                                                                                    <td style="padding-left: 24px; padding-top: 0; padding-right: 24px" data-breakpoint="4" valign="top" class="mobileClass-4">
                                                                                      <a href="https://twitter.com/ttsmgofficial"
                                                                                        ><img
                                                                                          ...
                                                                                          style="width: 40px; height: auto; max-width: 100%; display: block"
                                                                                          alt="Twitter icon"
                                                                                          src="https://cdn-images.mailchimp.com/icons/social-block-v3/block-icons-v3/twitter-filled-dark-40.png"
                                                                                          class=""
                                                                                      /></a>
                                                                                    </td>
                                                                                  </tr>
                                                  ...
                                                  <tr>
                                                    <td style="padding-right: 24px; padding-left: 24px" class="mceBlockContainer" valign="top">
                                                      <div data-block-id="3" class="mceText" id="dataBlockId-3" style="width: 100%">
                                                        <p class="last-child">*Automated Mailing System for Booking Submitted on The Tech Show at ${when} by ${email}. Our Team will reply on this Mail shortly for next steps.</p>
                                                      </div>
                                                    </td>
                                                  </tr>
                                                  <tr>
                                                    <td style="padding-top: 8px; padding-bottom: 8px; padding-right: 8px; padding-left: 8px" class="mceLayoutContainer" valign="top">
                                                      <table align="center" border="0" cellpadding="0" cellspacing="0" width="100%" role="presentation" data-block-id="11" id="section_ab83ce489ea15911d7ab34efa53e2c5d" class="mceFooterSection">
                                                        <tbody>
                                                          <tr class="mceRow">
                                                            <td style="background-position: center; background-repeat: no-repeat; background-size: cover" valign="top">
                                                                  ...
                                                                  <tr>
                                                                    <td style="padding-top: 0; padding-bottom: 0; margin-bottom: 12px" class="mceColumn" data-block-id="-3" valign="top" colspan="12" width="100%">
                                                                      <table border="0" cellpadding="0" cellspacing="0" width="100%" role="presentation">
                                                                        <tbody>
                                                                          <tr>
                                                                            <td style="padding-top: 12px; padding-bottom: 12px; padding-right: 48px; padding-left: 48px" class="mceBlockContainer" align="center" valign="top">
                                                                              <a href="https://yourtechshow.com"
                                                                                ><img
                                                                                  data-block-id="8"
                                                                                  width="130"
                                                                                  height="auto"
                                                                                  ...
                                                                                  alt="Logo"
                                                                                  src="https://mcusercontent.com/d07d3c39139812c7609be94b4/images/b65839ee-65aa-106f-1893-061c4b15af22.png"
                                                                                  class=""
                                                                                />
                                                                              </a>
                                                                            </td>
